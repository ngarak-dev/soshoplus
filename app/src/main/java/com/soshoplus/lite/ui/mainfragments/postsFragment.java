...
public class postsFragment extends Fragment {
    ...
    private simpleProfileCalls profileCalls;
...
//        });
    ...
    private void loadProfile() {
        profileCalls = new simpleProfileCalls(requireContext());
        profileCalls.getProfile(postsBinding.postTypes.profilePic, postsBinding.postTypes.fullName, null);
    }
}