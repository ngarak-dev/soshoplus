...
public class adHashPopup extends ImageViewerPopupView {
    public adHashPopup (@NonNull Context context) {
        super(context);
    }
    ...
    protected void onCreate () {
        ...
        /*getting ad info*/
        hashTagsPostsCalls.getADInfo(full_name, location, description,
                headline);
    }
