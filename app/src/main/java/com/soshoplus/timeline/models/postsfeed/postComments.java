...
public class postComments implements Serializable {
	...
	public postComments (String commentWonders, String cFile, boolean isCommentLiked, String orginaltext, String fullurl, boolean onwer, boolean isCommentWondered, String url, String pageId, boolean postOnwer, String postId, String userId, String record, String commentLikes, com.soshoplus.timeline.models.postsfeed.publisherInfo publisherInfo, String id, String text, String time) {
