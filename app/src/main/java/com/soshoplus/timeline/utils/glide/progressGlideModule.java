...
public class progressGlideModule extends AppGlideModule {
    ...
    public static void forget(String url) {
        progressGlideModule.DispatchingProgressListener.forget(url);
    }
    public static void expect(String url, progressGlideModule.UIonProgressListener listener) {
        progressGlideModule.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements progressGlideModule.ResponseProgressListener {
